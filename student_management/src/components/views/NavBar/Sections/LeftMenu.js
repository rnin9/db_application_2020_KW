...
function LeftMenu(props) {
  ...
  return (
    ...
    <SubMenu key="SubMenu" icon={<UserOutlined />} title="학생 정보" style={{fontSize:15}}>  {/*Navigation 종류*/}
    ...
    <SubMenu key="SubMenu2" icon={<FormOutlined />} title="수강현황" style={{fontSize:15}}>
    ...
    <Menu.Item key="SubMenu3" icon={<TeamOutlined/>}>  
      <a href="/friend" target="_blank" rel="noopener noreferrer" style={{fontSize:15}} > {/*새로운 페이지에서 보여줌.*/} 
        친구
      </a>
    </Menu.Item>
  </Menu>
