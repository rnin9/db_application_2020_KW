  ...
  >
    ...
    >
      <Menu.ItemGroup key="g1" title="수강관리">
        ...
        <Menu.Item key="3"><a href="/course/delete">수강삭제</a></Menu.Item>
      </Menu.ItemGroup>
    ...
    >
      <Menu.Item key="6"><a href="/user/notice">공지사항</a></Menu.Item>
      <Menu.Item key="7">게시판</Menu.Item>
      <Menu.Item key="8"><a href="/user/absense/request">휴학신청</a></Menu.Item>
    </SubMenu>
    <SubMenu key="sub3" icon={<TeamOutlined />} title="친구">
      <Menu.Item key="9"><a href="/user/friend/list">친구목록</a></Menu.Item>
      <Menu.Item key="10"><a href="/user/friend/add">친구추가</a></Menu.Item>
      <SubMenu key="sub4" title="공유">
        <Menu.Item key="11">시간표</Menu.Item>
        <Menu.Item key="12">성적</Menu.Item>
      </SubMenu>
    </SubMenu>
  </Menu>  
  </div>
